# Data Analyzer
Responsável por analisar o histórico de compras e prever os próximos itens a serem comprados, a suas quantidades e quando.
...
| `JOB_CRON` | Expressão cron do job de análise (formato Spring: segundos minutos horas dia-do-mês mês dia-da-semana) | `0 0 0 * * *` |
